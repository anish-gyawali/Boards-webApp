...
class PasswordChangeTests(TestCase):
    def setUp(self):
        ...
        user = User.objects.create_user(
            username=username, email='Anish@hero.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    def setUp(self, data={}):
        self.user = User.objects.create_user(
            username='Anish', email='Anish@hero.com', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='Anish', password='old_password')
